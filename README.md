...
Population Annealing Monte Carlo (PAMC) is a flexible and scalable Monte Carlo algorithm for simulating equilibrium and nonequilibrium statistical physics systems. This implementation is designed to be flexible and parallel, supporting OpenMP parallelization, with planned extensions for MPI and GPU acceleration.
